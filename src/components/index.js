  ...
  sendEmail = () => {
    ...
    if (window.Email) {
      ...
      const config2 = {
        ...
        Body: "we had recorded your response",
      };
      ...
      <div className="page-container">
        <div className="page-body">
          ...
          <div className="first-div">
            <img className="first-image" src={img1} alt="img1" />
            <div>
          ...
          <div className="first-div">
            ...
            <img className="first-image" src={img2} alt="img1" />
          </div>

          {/** third div */}
          <div className="last-div">
            <img className="first-image" src={img3} alt="img1" />
            <div>
